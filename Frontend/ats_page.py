...
class Ats_page():
    ...
    # Resume Title
        try:
            st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>Resume Analysis</font></h1>", unsafe_allow_html=True)
            # Upload resume file
            ...
            if st.button("Scan Resume"):
                ...
                if "PERSON" in entities:
                    ...
                    name = name.upper() 
                    st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>Name:</font></h1>", unsafe_allow_html=True)
                ...
                st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>Contact No:</font></h1>", unsafe_allow_html=True)
                # Define CSS style for highlighting
                highlight_style = "font-size: 16px; padding: 8px; background-color: white ; color: black; border-radius: 5px; text-align: center; line-height: 2.5;"
                # Generate HTML for displaying skills with highlighting
                ...
                st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>Email:</font></h1>", unsafe_allow_html=True)
                # Define CSS style for highlighting
                highlight_style = "font-size: 16px; padding: 8px; background-color: white ; color: black; border-radius: 5px; text-align: center; line-height: 2.5;"
                # Generate HTML for displaying skills with highlighting
                ...
                # Display user skills
                st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>User Unique Skills:</font></h1>", unsafe_allow_html=True)
                # Define CSS style for highlighting
                ...
                st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>Distribution of Skills:</font></h1>", unsafe_allow_html=True)
                ...
                # Display the table
                st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>Hard Skills:</font></h1>", unsafe_allow_html=True)
                ...
                df = pd.DataFrame(data)
                # Display the table
                st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>Soft Skills:</font></h1>", unsafe_allow_html=True)
                ...
                ################################################################################################################################
                st.markdown("<h1 style='color: #37B7C3;'> <font size='6'>ATS Checker & Tips:</font></h1>", unsafe_allow_html=True)
            ...
            with st.sidebar:
                ...
                if user_resume and job_description:
                    ...
                    if job_match:
                        ...
                        st.markdown("<h1 style='color: #37B7C3; padding-left:10px ; text-align: center;'> <font size='6'>Match Rate</font></h1>", unsafe_allow_html=True)
