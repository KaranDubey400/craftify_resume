...
class About_section():
    def About_Section():
        ...
        st.markdown("<h1 style='color:  #37B7C3;'>About Craftify</h1>", unsafe_allow_html=True)
        ...
        st.markdown("---")
        # How It Works
        st.markdown("<h2 style='color: #37B7C3;'>How It Works:</h2>", unsafe_allow_html=True)
        st.markdown("<h3 style='color:  #37B7C3;'>1. Resume Analysis:</h3>", unsafe_allow_html=True)
        ...
        st.markdown("<h3 style='color: #37B7C3;'>2. Keyword Implementation:</h3>", unsafe_allow_html=True)
        ...
        st.markdown("<h3 style='color:  #37B7C3;'>3. Job Search Recommendations:</h3>", unsafe_allow_html=True)
